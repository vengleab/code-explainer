...
PALETTES = {
    ...
    "dark": dict(
        ...
        code=(248, 248, 242),     # --code-fg
        kw=(102, 217, 239),       # --code-keyword
        s=(230, 219, 116),        # --code-string
        func=(166, 226, 46),      # --code-func (monokai function name/call)
    ...
    "light": dict(
        ...
        gutter=(107, 112, 133),   # --mute (line numbers)
        code=(0, 0, 0),           # --code-fg-light
        kw=(0, 128, 0),           # --code-keyword-light
        s=(186, 33, 33),          # --code-string-light
        func=(0, 0, 255),         # --code-func-light (pygments default/Jupyter function name/call)
